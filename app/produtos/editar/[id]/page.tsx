              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="product-status">Ativo</Label>
                  </div>
                  <Link href={`/loja-brindes/${id}`} target="_blank" rel="noopener noreferrer">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label htmlFor="isPrivate">Produto Privado</Label>
                  <Switch
                    id="isPrivate"
                    checked={isPrivate}
                ...
                <div className="space-y-2">
                  ...
                  {isPrivate && (
                    <p className="text-sm text-muted-foreground">
                      Este produto será visível apenas para usuários autorizados.
                    </p>
                  )}
                </div>
              </div>
