          ...
          {orders.map((order) => (
            <TableRow key={order.id}>
                  ...
                  <DialogContent>
                    ...
                    <div className="grid gap-4 py-4">
                      <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <span className="col-span-3">{order.product}</span>
                      </div>
                      <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <span className="col-span-3">R$ {order.price.toFixed(2)}</span>
                      </div>
                      <div className="grid grid-cols-4 items-center gap-4">
                        <span className="font-bold">Método de Pagamento:</span>
                        <span className="col-span-3">{order.paymentMethod}</span>
                      </div>
                      <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <span className="col-span-3">{order.user}</span>
                      </div>
                    </div>
                  </DialogContent>
                </Dialog>
              ...
              <TableCell>
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="link">{order.user}</Button>
                  </DialogTrigger>
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Detalhes do Usuário</DialogTitle>
                      <DialogDescription>
                        Informações detalhadas sobre {order.user}.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                      <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <span className="col-span-3">{order.user.toLowerCase().replace(' ', '.')}@example.com</span>
                      </div>
                      <div className="grid grid-cols-4 items-center gap-4">
                        <span className="font-bold">Telefone:</span>
                        <span className="col-span-3">(11) 98765-4321</span>
                      </div>
                      <div className="grid grid-cols-4 items-center gap-4">
                        <span className="font-bold">Endereço:</span>
                        <span className="col-span-3">Rua Exemplo, 123 - São Paulo, SP</span>
                      </div>
                    </div>
                  </DialogContent>
                </Dialog>
